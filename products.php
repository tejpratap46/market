						...
						<div class="col-md-3 product-filter-grid1-brands">
							...
							for($i = 0; $i < mysql_num_rows ( $brandsQuery ); $i ++) {
								...
								if ($i % 2 == 0) {
									...
									echo "<li><a href='#'>" . $brandInfo ['itembrand'] . "</a></li>";
			...
			<div class="container">
				<div class="special-products all-poroducts">
					<div class="s-products-head">
						...
						<div class="s-products-head-right">
							<a href="newarrivals.php"><span> </span>view all products</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<!--special-products-grids-->
					<div class="special-products-grids">
					<?php
					$query = mysql_query ( "SELECT * FROM market ORDER BY `date` DESC LIMIT 12" ) or die ( "{\"status\":0," . "\"error\":\"" . mysql_error () . "\"}" );
					showData ( $query );
					?>
					<div class="clearfix"></div>
					</div>
