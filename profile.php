		...
		if ($_COOKIE ['username']) {
			...
			for($i = 0; $i < mysql_num_rows ( $quary ); $i ++) {
				...
				echo "	<div class='container'>
							<div style='text-align: center;' class='col-md-4'><button style='width: 95%;padding: 5%; margin:5%;' class='btn btn-lg btn-danger' type='button' onclick=\"removeList('" . $qArray ['listid'] . "')\" >Delete List</button></div>
							<div style='text-align: center;' class='col-md-4'><button style='width: 95%;padding: 5%; margin:5%;' class='btn btn-lg btn-success' type='button' onclick=\"makeFirstList('" . $qArray ['listid'] . "')\" >Make It First</button></div>
							<div style='text-align: center;' class='col-md-4'><button style='width: 95%;padding: 5%; margin:5%;' class='btn btn-lg btn-primary' type='button' onclick=\"window.location.href = 'map.php?floor=G1&listid=" . $qArray ['listid'] . "';\" >Get Map</button></div>
						</div>";
				echo "</div>";
			}
		} else {
