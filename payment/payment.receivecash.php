...
if ($balance && $fromid) {
	...
	if ($query1) {
    	...
    	$id = newRandomId();
		$query = mysql_query ( "INSERT INTO `payment_completed`(`id`, `fromid`, `toid`, `balance`, `listid`) VALUES ('$id','$fromid','".Config::BANK_ID."','$balance','')" ) or die ( "{\"status\":0," . "\"error\":\"" . mysql_error () . "\"}" );
