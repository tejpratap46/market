			...
			<div class="top-header-info">
				...
				<div class="cart-details">
					...
					<div class="login-rigister"
						<?php if (isset($_SESSION['username'])){echo "hidden";}?>>
						<ul class="unstyled-list list-inline">
					...
					<div class="login-rigister"
						<?php if (!isset($_SESSION['username'])){echo "hidden";}?>>
						<ul class="unstyled-list list-inline">
							<li><a class="rigister" href="profile.php"><?php echo $_SESSION['username']?><span>
								</span></a></li>
							<div class="clearfix"></div>
						</ul>
					</div>
		...
		<div class="container">
			<div class="contact-grids">
				<div class="col_1_of_bottom span_1_of_first1">
					<h5>Address</h5>
					<ul class="list3">
						<li><img src="web/images/home.png" alt="">
				...
				<div class="col_1_of_bottom span_1_of_first1">
					<h5>Phones</h5>
					<ul class="list3">
						<li><img src="web/images/phone.png" alt="">
							<div class="extra-wrap">
								<p>
									<span>Telephone:</span>+1 800 258 2598
								</p>
							</div> <img src="web/images/fax.png" alt="">
							<div class="extra-wrap">
								<p>
				...
				<div class="col_1_of_bottom span_1_of_first1">
					<h5>Email</h5>
					<ul class="list3">
						<li><img src="web/images/email.png" alt="">
							<div class="extra-wrap">
								<p>
	...
	<div class="footer">
		<div class="container">
			<div class="col-md-3 footer-logo">
				<a href="index.html"><img src="web/images/flogo.png"
					title="brand-logo" /></a>
			</div>
