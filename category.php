...
<html>
<head>
<title><?php echo $_GET['c'];?> :: One Store</title>
						...
						<div class="col-md-3 product-filter-grid1-brands">
							...
							for($i = 0; $i < mysql_num_rows ( $brandsQuery ); $i ++) {
								...
								if ($i % 2 == 0) {
									...
									echo "<li><a href='brand.php?c=" . $_GET ['c'] . "&brand=" . $brandInfo ['itembrand'] . "'>" . $brandInfo ['itembrand'] . "</a></li>";
			...
			<div class="special-products all-poroducts">
				<div class="s-products-head">
					<div class="s-products-head-left">
						<h3>
							CATEGOTY <span><?php echo strtoupper($_GET['c']);?></span>
						</h3>
					</div>
				...
				<div class="special-products-grids">
					<?php
					$query = mysql_query ( "SELECT * FROM market WHERE itemcategory='" . $_GET ['c'] . "' ORDER BY `totalsold` DESC LIMIT 12" ) or die ( "{\"status\":0," . "\"error\":\"" . mysql_error () . "\"}" );
					showData ( $query );
					?>
					<div class="clearfix"></div>
				</div>
